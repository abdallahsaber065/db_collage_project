    ...
    try {
      ...
      const coursesWithDetails = await Promise.all(
        response.data.map(async (course) => {
          const detailsResponse = await api.get(`/courses/${course.CourseID}`);
          ...
          <TableBody>
            {courses.map((course) => (
              <TableRow key={course.CourseID}>
                ...
                <TableCell>
                  <IconButton onClick={() => handleOpen(course)} disabled={isPreviewMode}>
                    <EditIcon />
                  </IconButton>
                  <IconButton onClick={() => handleDelete(course.CourseID)} disabled={isPreviewMode}>
                    <DeleteIcon />
                  </IconButton>
                </TableCell>
              </TableRow>
